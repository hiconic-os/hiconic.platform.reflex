...
* `demo-app` defines our application as a bundle of the `reflex-platform`, our `demo-rf-module` and a module that provides a web server with a REST endpoint (`web-api-undertow-rx-module`).
