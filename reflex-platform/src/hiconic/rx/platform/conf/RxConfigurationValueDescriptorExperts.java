...
public final class RxConfigurationValueDescriptorExperts {
	...
	public static ValueDescriptorExpressionCodec expressionCodec() {
		return new ModelBasedValueDescriptorExpressionCodec( //
				Decrypt.T, PackagedSource.T, PackagedResource.T, PackagedResourceText.T, ResourceText.T);
	}

	public static void register(ValueDescriptorExpertRegistry registry, RxPackagedResourceResolver resources, RxPropertyResolver properties) {
