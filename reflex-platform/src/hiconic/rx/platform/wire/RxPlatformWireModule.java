...
import hiconic.rx.platform.wire.space.RxApplicationFilesSpace;
...
public class RxPlatformWireModule implements WireTerminalModule<RxPlatformContract> {
	...
	public void configureContext(WireContextBuilder<?> contextBuilder) {
		...
		contextBuilder.bindContract(RxApplicationFilesContract.class, RxApplicationFilesSpace.class);
