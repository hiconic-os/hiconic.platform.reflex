...
public class RxPlatformSpace extends CoreServicesSpace implements ExtendedRxPlatformContract, RxProcessLaunchContract {
	...
	@Import private RxApplicationFilesSpace applicationFiles;
	@Import private RxAuthSpace auth;
	...
	@Override public RxApplicationFilesContract applicationFiles() { return applicationFiles; }
