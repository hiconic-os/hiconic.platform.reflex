...
@Managed
public class RxPackagedPublicResourcesSpace implements RxPackagedPublicResourcesContract {
	...
	private RxIndexedPackagedResourceResolver resolver() {
		return new RxIndexedPackagedResourceResolver(config.classpathIndex(), CLASSPATH_ROOT, PackagedResourceNamespace.publicResources);
	}
}
