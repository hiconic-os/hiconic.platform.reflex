 ...
 * @author peter.gazdik
 */
public class ResourcesStorageRegistry {
	...
	public ResourceStorage byName(String name) {
		throw new UnsupportedOperationException("Method 'ResourcesStorageRegistry.byName' is not implemented yet!");
	}
	...
	public Maybe<ResourceStorage> resolveDefaultStorage(EntityType<? extends ResourceSource> source) {
		throw new UnsupportedOperationException("Method 'ResourcesStorageRegistry.resolveDefaultStorage' is not implemented yet!");
	}
