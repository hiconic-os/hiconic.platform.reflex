 ...
 */
@Description(
	"This type models typesafe command line options for Jinni." 
)	
@Alias("options")
public interface Options extends GenericEntity {
	...
	@Description(
		"Route the protocol of the request processing to a channel defined by the given value. "
	...
	@Description(
			"Activates the ansi escaped sequence styled output of the protocol."
		)	
	@Initializer("true")
	boolean getColored();
