...
// ============================================================================
package hiconic.rx.platform.test.wire;
...
public enum PlatformRxTestModule implements RxModule<PlatformRxTestModuleSpace> {
	INSTANCE;

	@Override
	public void bindExports(Exports exports) {
		exports.bind(PlatformTestContract.class, PlatformRxTestModuleSpace.class);
	}
