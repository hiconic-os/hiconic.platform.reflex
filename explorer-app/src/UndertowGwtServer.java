...
public class UndertowGwtServer {
	...
	public static void main(String[] args) {
		...
		String webappDir = "web-app/tribefire-explorer"; // Update this to the actual path

		// Create a deployment for the GWT application
		DeploymentInfo servletBuilder = Servlets.deployment() //
				.setClassLoader(UndertowGwtServer.class.getClassLoader()) //
//				.setContextPath("/tribefire-explorer") // Set the context path for your app
				.setContextPath("") // Set the context path for your app
